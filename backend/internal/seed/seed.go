...
var users = []userSeed{
	...
	},
	{
		...
		Recommended:           false,
		Posts: []postSeed{
			{DaysAgo: 2, Hour: 18, ExerciseType: 3, DurationMinutes: 70, Note: "スクワット中心。下半身を重点的にトレーニングしました。"},
			{DaysAgo: 3, Hour: 19, ExerciseType: 2, DurationMinutes: 60, Note: "デッドリフトとローイングを実施。背中を中心に鍛えました。"},
			{DaysAgo: 4, Hour: 20, ExerciseType: 1, DurationMinutes: 45, Note: "ベンチプレスとダンベルプレスを実施。胸を中心にトレーニングしました。"},
			{DaysAgo: 5, Hour: 18, ExerciseType: 4, DurationMinutes: 50, Note: "ショルダープレスとサイドレイズを実施。肩まわりを重点的に鍛えました。"},
			{DaysAgo: 6, Hour: 19, ExerciseType: 5, DurationMinutes: 40, Note: "腹筋と体幹トレーニングを実施。フォームを意識しました。"},
			{DaysAgo: 7, Hour: 17, ExerciseType: 2, DurationMinutes: 65, Note: "ラットプルダウンとローイングを実施。背中の収縮を意識しました。"},
			{DaysAgo: 8, Hour: 20, ExerciseType: 3, DurationMinutes: 55, Note: "レッグプレスとスクワットを実施。脚全体を鍛えました。"},
		},
	},
	{
		Username:              "Carol Sato",
